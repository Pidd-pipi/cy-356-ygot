...
func TestAuditRepository_ListFilter(t *testing.T) {
	...
	for i := 0; i < 3; i++ {
		log := &model.AuditLog{UserID: 1, Username: "admin", Role: "admin", Action: "APPROVE_APPLICATION", ResourceType: "adoption_application", ResourceID: "1", Detail: "认养", RequestID: "req"}
	...
	list, total, err := repo.List(util.PageQuery{Page: 1, PageSize: 10}, "APPROVE_APPLICATION", "")
	...
	if err != nil || got.Action != "APPROVE_APPLICATION" {
