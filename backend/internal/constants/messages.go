...
const (
	...
	MsgApplicationSubmitted = "认养申请已提交，请等待管理员审核"
	MsgApplicationApproved  = "认养申请已批准，地块归申请人认养"
	MsgApplicationRejected  = "认养申请已拒绝，申请人可选择其他空闲地块"
	MsgApplicationWithdrawn = "认养申请已撤回"
	MsgAutoRejectNote       = "同地块其他居民的申请已获批准，系统自动拒绝"
